...
With those other products, if you didn’t start them at the beginning of your session, you have to manually “spin them up” first. Their seamless experience only works if you planned to use them from the start.
